...
public class URLEncodedUtils {
  ...
  /**
   * Returns Map<String, Set<String>> as built from the URI's query portion. For example, a URI of
   * http://example.org/path/to/file?a=1&b=2&c=3&c=4 would return a Map three key is a name name of
   * parameter Set<String> is a values, a={1}, one for b={2} and two for c={3,4}.
   *
   * <p>
   *
